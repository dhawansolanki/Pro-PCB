...
import React, { Image, Fragment, useContext } from "react";
    ...
    <Fragment>
      ...
      <LayoutOne>
        ...
        <div className="headernav1">
          <img src="https://lh3.googleusercontent.com/drive-viewer/AJc5JmTQ2bvNNWfboLDEyQ68KtVysOBhdSidxlrpX5RNllhtHscwGAfueLk4hnPmr83MOD_JUPGn3GE=w2880-h1528" />
        </div>
                ...
                >
                  ...
                  <form className="contact-form-style ">
                    <div className="row quote-form">
                      <div className="inputfilediv1">
                        {/* <div className="col-lg-12 form-items quote"> */}
                        <div className="textinsidefileinput">
                          Drag’n drop or click to upload files
                        </div>
                        <input
                      ...
                      <label>
  <input type="radio" name="test" value="FR-4" onChange={handleChange} defaultValue="FR-4" checked/>
  <img class="radioimg" src="https://media.graphassets.com/output=format:jpg/resize=height:800,fit:max/qQR74dLFRHKtfZtcXR7D" alt="Option 1"/>
</label>

<label>
  <input type="radio" name="test" value="Aluminium"/>
  <img class="radioimg" src="https://media.graphassets.com/output=format:jpg/resize=height:800,fit:max/BdSU1hu9QkmMmaXRplzh" alt="Option 2"/>
</label>
                      <div className="col-lg-12 form-items quote">
                        <ul>
                          <li>
