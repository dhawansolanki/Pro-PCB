import { AppPreferences, BoardRender, BoardSummary, BoardUpdate, LayerVisibilityMap, Mode, ErrorObject } from '../types';
...
export declare type Dispatch = (action: Action) => Action;
export declare type Store = {
    getState: () => State;
    dispatch: Dispatch;
};
export declare type Middleware = (store: Store) => (next: Dispatch) => Dispatch;
